	...
	public function tambah_buku()
	{
		...
		{	
			...
			else
			{
				...
				if($isi==0){
					$upload_surat = $_FILES['gambar']['name'];
					if ($upload_surat) {
	...
	public function edit_buku()
	{
		...
		{	
			...
			/*layout*/	
				...
				$data['data_pengarang'] = $this->Buku_model->getAllData("tb_pengarang");
				$data['data_rak'] = $this->Buku_model->getAllData("tb_rak");
				$data['buku'] = $this->Buku_model->get_detail('tb_buku','id_buku', $id_buku)->row_array();
	...
	public function update_buku()
	{
		...
		{	
			...
			else
			{
				...
				$id = $this->input->post('id_buku_lama');	
				$field='id_buku';
		        $data = array(
							'id_buku' => $this->input->post('id_buku'),
							'ISBN' => $this->input->post('ISBN'),
				...
				$this->Buku_model->updateData1('tb_buku',$data,$field,$id);		
				redirect('petugas/Buku/Buku','refresh');
				$this->session->set_flashdata("message","Data Berhasil Diubah!");
					redirect("petugas/Buku","refresh");	
