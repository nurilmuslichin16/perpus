        ...
        public function create()
    {
        ...
        {   
                ...
                else
                {
                    ...
                    $querybaru=$this->Buku_model->insertData('tb_kelas',$data);
                    ...
                    if ($querybaru) {
                        ...
                        redirect("petugas/Kelas/create","refresh");	
                    } 
                }
        }
        else
    ...
    public function update()
    {
        ...
        {       
                ...
                if($this->form_validation->run()==FALSE)
                {
                    ...
                    $data['kelas'] = $this->Buku_model->get_detail1('tb_kelas','id_kelas',$id);
                    //$data['data_agama'] = $this->Buku_model->getAllData("tb_agama");
                    $tmp['content']=$this->load->view('petugas/provinsi/Edit_kelas',$data,true);
                    $this->load->view('petugas/layout',$tmp);
                }
                else
                {
                    ...
                    $querybaru=$this->Buku_model->updateData1('tb_kelas',$data,$field,$id);
                    ...
                    if ($querybaru) {
                        ...
                        $this->session->set_flashdata("message","gagal!!!");
                        redirect("petugas/Kelas/edit","refresh");	
                    }  
                }
        }
        else
