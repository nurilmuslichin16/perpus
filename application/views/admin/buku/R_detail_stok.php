        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Anda akan menghapus Detail Jumlah buku ini</p>
...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
    <h3 class="box-title"><i class="fa fa-book"></i> Daftar Detail Jumlah Buku</h3>
   ...
   <div class="btn-group"><a href="<?php echo base_url(); ?>admin/Buku/tambah_det_buku/?id_buku=<?php echo $id;?>"  class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Data Detail Jumlah Buku"><i class="fa fa-plus"></i>Tambah Detail Jumlah Buku</a></div>
