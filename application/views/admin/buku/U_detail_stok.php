...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
    <h3 class="box-title"><i class="fa fa-pencil"></i> <i class="fa fa-book"></i>Edit Detail Jumlah Buku</h3>
...
<?php }?>
  ...
  <div class="box-footer">
    Update Data Detail Jumlah Buku Perpustakaan, edit form diatas untuk mengubah data detail buku. 
  </div><!-- box-footer -->
</div><!-- /.box -->
