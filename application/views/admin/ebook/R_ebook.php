...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
   ...
   <div class="btn-group"><a href="<?php echo base_url(); ?>admin/ebook/tambah_ebook"  class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Data E-Book"><i class="fa fa-file-pdf-o"></i>  Tambah Data E-Book</a></div>
            ...
            <tr>
                ...
                <?= 
                    ...
                    <a href="'.base_url().'assets/file/'.$op['file'].'" class="btn btn-info" role="button" data-toggle="tooltip" title="Download" download><i class="fa fa-download"></i></a>
                     ...
                     <a href="'.base_url().'admin/Ebook/edit_ebook/?id_ebook='.$op['id_ebook'].'" class="btn btn-warning" role="button" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                    <span data-toggle="modal" data-target="#confirm-delete" data-href="'.base_url().'admin/Ebook/hapus_ebook/?id_ebook='.$op['id_ebook'].'">
