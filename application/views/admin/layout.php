...
<head>
  ...
  <title>Perpustakaan SMA N 1 Pekalongan</title>
    <link rel="icon" href="<?= base_url("assets/logo/logo.png") ?>" type="image/gif">
  <!-- Font Awesome -->
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="header" style="letter-spacing: 4px;">MASTER DATA</li>
        <li class="treeview">
          <a href="#">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-file"></i> <span>Master E-Book</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url(); ?>admin/Ebook/ebook"><i class="fa fa-file-pdf-o"></i>Data E-Book</a></li>
            <li><a href="<?php echo base_url(); ?>admin/Mapel"><i class="fa fa-leanpub"></i>Data Mata Pelajaran</a></li>
          </ul>
        </li>

        <li class="header" style="letter-spacing: 4px;"> TRANSAKSI</li>
         <li class="treeview">
          <a href="#">
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
              <li><a href="<?php echo base_url(); ?>admin/Report"><i class="fa fa-book"></i>Laporan Buku </a></li>
              <li><a href="<?php echo base_url(); ?>admin/Report/pinjam"><i class="fa fa-book"></i>Laporan Pinjam</a></li>
              <li><a href="<?php echo base_url(); ?>admin/Report/pengembalian"><i class="fa fa-book"></i>Laporan Pengembalian</a></li>
          </ul>
        </li>
        <li class="header" style="letter-spacing: 4px;">DENDA</li>
        <li><a href="<?php echo base_url();?>admin/Denda"><i class="fa fa-usd"></i> <span>Denda</span></a></li>

         <li class="header" style="letter-spacing: 4px;">PETUGAS/OPERATOR</li>
  ...
  <footer class="main-footer">
    ...
    <strong>
                      <center>
                        Copyright &copy; 2020 Rastra Dimas Pratama
                      </center>  
    </strong> 
  </footer>
