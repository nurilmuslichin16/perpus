  ...
  <form class="form-horizontal" method="post" <?php echo form_open_multipart('admin/Petugas/Update');?>
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" value="<?php echo $petugas['id_petugas'];?>" class="form-control" name="id_petugas" placeholder="id Lengkap" >
                     <input type="hidden" value="<?php echo $petugas['id_petugas'];?>"  name="id_petugas_lama" >
                  </div>
                </div>
                  <div class="form-group">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                  <img width="40%" src="<?php echo base_url();?>gambar_petugas/<?php echo $petugas['img'];?>">
