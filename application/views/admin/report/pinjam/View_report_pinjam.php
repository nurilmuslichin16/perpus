...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
   ...
   <table id="table-buku1" class="table table-striped table-bordered" cellspacing="0" width="100%">
    ...
    <div> <h3><a class="btn btn-success" href="<?php echo base_url(); ?>admin/Report/pdf_pinjam">Export PDF</a></h3> </div>
    <div> <h3><a class="btn btn-warning" href="<?php echo base_url(); ?>admin/Report/excel_pinjam">Export Excel</a></h3> </div>
  </div>
