...
<body>
    <div class="navbar navbar-inverse set-radius-zero"  style="background-image: url(<?= base_url("./assets2/img/Banner14_.jpg") ?>); background-size: cover; background-attachment: fixed; background-position: center; border: none; height: 100%; width: 100%;">
        <div class="container">
            <div class="left-div">
                <div class="user-settings-wrapper">
                    <ul class="nav">
                    <center>
                        <img style="border: none; width: 150px; height: 150px;" src="<?= base_url("assets/logo/logo.png") ?>" alt="Logo SMA N 1 Pekalongan">
                        <h1>  &nbsp; </h1>
                    </center>   
                    </ul>
                </div>
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-left">
                            ...
                            <li><a href="<?php echo base_url();?>Buku/list_ebook">List E-Book</a></li>
