  ...
  <div class="box-header with-border">
   ...
   <div class="box-body">
    ...
    <!--show error message here -->
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>petugas/Anggota/create" role="form">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">ID Anggota</label>
                  <div class="col-sm-4">
                    <input type="number" class="form-control" name="id" placeholder="ID Anggota" required="required" >
                  </div>
                </div>
                <div class="form-group">
