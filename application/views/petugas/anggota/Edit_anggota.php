...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
   ...
   <div class="box-body">
	...
	<form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>petugas/Anggota/update" role="form">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">ID ANGGOTA</label>
                  <div class="col-sm-4">
                    <input type="text" value="<?php echo $anggota['id_anggota'];?>"  class="form-control" name="id_anggota" placeholder="id Lengkap" >
                     <input type="hidden" value="<?php echo $anggota['id_anggota'];?>"  name="id_anggota_lama" >
                  </div>
                </div>
                <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <?php } else { ?>
                    <label class="col-sm-2 control-label">Foto</label>
                    <div class="col-sm-5">
                      <img width="40%" src="<?= base_url('assets/foto/'. $anggota['foto']) ?>">
                      <br/>
