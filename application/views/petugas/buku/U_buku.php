...
<div class="box box-solid box-primary">
  <div class="box-header with-border">
   ...
   <div class="box-body">
	...
	<form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>petugas/Buku/update_buku" role="form">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label">ID Buku</label>
                  <div class="col-sm-4">
                    <input type="text" value="<?php echo $buku['id_buku'];?>"  class="form-control" name="id_buku"  placeholder="ID Buku" >
                    <input type="hidden" value="<?php echo $buku['id_buku'];?>"  name="id_buku_lama" >
                  </div>
                </div>
                 <div class="form-group">
                  <label class="col-sm-2 control-label">ISBN</label>
                  <div class="col-sm-3">
                    <input type="text" value="<?php echo $buku['ISBN'];?>" class="form-control" name="ISBN" placeholder="ISBN">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Judul</label>
                  <div class="col-sm-6">
                    <input type="text" value="<?php echo $buku['judul'];?>" class="form-control" name="judul" placeholder="Judul Buku" >
                  </div>
                </div>
                <div class="form-group">
                 <label class="col-sm-2 control-label">Kategori</label>
                  <div class="col-sm-5">
		               <select name="kategori" class="js-example-basic-single form-control" data-placeholder="Klik untuk memilih">
                            ...
                            {
                            ?>
                              <?php  if($op2['id_kategori']== $buku['id_kategori']){
                              ?>
              ...
              <div class="form-group">
                 ...
                 <div class="col-sm-5">
                    ...
                    <?php foreach($data_penerbit->result_array() as $op2)
                            {
                            ?>
                              <?php  if($op2['id_penerbit']== $buku['id_penerbit']){
                              ?>
              ...
              <div class="form-group">
                 ...
                 <div class="col-sm-5">
                    ...
                    <?php foreach($data_pengarang->result_array() as $op2)
                            {
                            ?>
                              <?php  if($op2['id_pengarang']== $buku['id_pengarang']){
                              ?>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                   <input name="thn_terbit" value="<?php echo $buku['thn_terbit'];?>" class="date-own form-control" maxlength="4" type="text" placeholder="Tahun terbit">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Keterangan</label>
                  <div class="col-sm-5">
                   <textarea class="form-control" name="keterangan" rows="4" placeholder="Keterangan"><?php echo $buku['ket'];?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <?php if ($buku['gambar'] == '') { ?>
                  ...
                  <?php } else { ?>
                    ...
                    <div class="col-sm-5">
                      <img width="40%" src="<?= base_url('assets/gambar/'. $buku['gambar']) ?>">
                      <br/>
                      <label class="control-label">Ubah Gambar Buku</label>
                      <br/>
                      <input type="file" name="gambar" class="form-control">
                    </div>
                  <?php } ?>
