    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url(); ?>petugas/Ebook/ebook"><i class="fa fa-file-pdf-o"></i>Data E-Book</a></li>
            <li><a href="<?php echo base_url(); ?>petugas/Mapel"><i class="fa fa-leanpub"></i>Data Mata Pelajaran</a></li>
          </ul>
        </li>
        ...
        <li class="header" style="letter-spacing: 4px;"> TRANSAKSI</li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
              <li><a href="<?php echo base_url(); ?>petugas/Report"><i class="fa fa-book"></i>Laporan Buku </a></li>
              <li><a href="<?php echo base_url(); ?>petugas/Report/pinjam"><i class="fa fa-book"></i>Laporan Pinjam</a></li>
