...
<?php
  ...
  ?>            
    ...
    <div> <h3><a class="btn btn-success" href="<?php echo base_url(); ?>petugas/report/pdfkan">Export PDF</a></h3> </div>
    <div> <h3><a class="btn btn-warning" href="<?php echo base_url(); ?>petugas/report/excel">Export Excel</a></h3> </div>
  </div>
